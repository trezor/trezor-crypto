...
START_TEST(test_bip32_cardano_v1_hdnode_vector_1)
{
	HDNode node;
	...
	hdnode_from_seed_cardano_v1(seed, seed_len / 8, &node);
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_2)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000000, 1);
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_3)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000001, 1);
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_4)
{
	HDNode node;
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_5)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000000, 1);
	hdnode_private_ckd_cardano(&node, 0x80000001, 1);
	hdnode_private_ckd_cardano(&node, 0x80000002, 1);
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_6)
{
	HDNode node;
...
START_TEST(test_bip32_cardano_v1_hdnode_vector_7)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000002, 1);
	hdnode_private_ckd_cardano(&node, 0x80000002, 1);
	hdnode_private_ckd_cardano(&node, 0xBB9ACA00, 1);
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_1)
{
	HDNode node;
	...
	ck_assert_int_eq(seed_len, 132);
	hdnode_from_seed_cardano_v2(NULL, 0, seed, seed_len / 8, &node);
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_2)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000000, 2);
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_3)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000001, 2);
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_4)
{
	HDNode node;
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_5)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000000, 2);
	hdnode_private_ckd_cardano(&node, 0x80000001, 2);
	hdnode_private_ckd_cardano(&node, 0x80000002, 2);
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_6)
{
	HDNode node;
...
START_TEST(test_bip32_cardano_v2_hdnode_vector_7)
{
	HDNode node;
	...
	hdnode_private_ckd_cardano(&node, 0x80000002, 2);
	hdnode_private_ckd_cardano(&node, 0x80000002, 2);
	hdnode_private_ckd_cardano(&node, 0xBB9ACA00, 2);
